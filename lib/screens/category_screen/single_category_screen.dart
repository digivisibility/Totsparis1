...
class SingleCategoryScreen extends StatefulWidget {
  const SingleCategoryScreen({super.key, required this.categoryId, required this.categoryName, required this.categoryList, required this.categoryModel});
                            ...
                            if (filterDataModel.isFiltered) {
                              ...
                              if (filteredProducts.isNotEmpty) {
                                return GridView.builder(
                                  ...
                                  gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                                    ...
                                    childAspectRatio: isSingleView ? 0.86 : 0.51,
                                  ),
                              ...
                              return GridView.builder(
                                ...
                                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                                  ...
                                  crossAxisSpacing: 10.0,
                                  mainAxisSpacing: 10.0,
                                  childAspectRatio: isSingleView ? 0.86 : 0.62,
                                ),
