          ...
          child: SingleChildScrollView(
            child: widget.productModel.type == 'simple'
                ...
                : productVariation.when(data: (snapShot) {
                    ...
                    if (counter <= 1 && snapShot.isNotEmpty) {
                          ...
                          children: [
                            ...
                            CarouselSlider.builder(
                              ...
                              itemBuilder: (BuildContext context, int itemIndex, int pageViewIndex) {
                                String displayImage = widget.productModel.images?[itemIndex].src ?? '';
                                if (variationImage != '' && itemIndex == 0) {
                                  displayImage = variationImage;
                                }
                                return Container(
                            ...
                            Positioned(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  GestureDetector(
                                    onTap: () {
                                      Share.share('${widget.productModel.name}. Buy Now at: https://www.totsparis.com/?p=${widget.productModel.id}');
                                    },
                                    child: Container(
                                      height: 35,
                                      width: 35,
                                                ...
                                                itemBuilder: (context, index) => GestureDetector(
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Container(
                                                      decoration: BoxDecoration(
                                                        borderRadius: const BorderRadius.all(Radius.circular(30)),
                                                        color: selectedAttributes[i] == attributeList[i][index]
                                                            ? secondaryColor1
                                                            : isDark
                                                                ? darkContainer
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child: Center(
                                                          child: MyGoogleText(
                                                            ...
                                                            fontSize: 18,
                                                            fontColor: selectedAttributes[i] == attributeList[i][index]
                                                                ? Colors.white
                                                                : isDark
                                                                    ? darkTitleColor
                                                                    : lightTitleColor,
                          ...
                          onPressFunction: () {
                            if (alreadyInCart == false) {
                              cart.addItemInfo(CartOtherInfo(
                                ...
                                productImage: widget.productModel.images != null && widget.productModel.images!.isNotEmpty ? widget.productModel.images![0].src : '',
