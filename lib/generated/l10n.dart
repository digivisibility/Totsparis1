...
class S {
  ...
  String get storeTitle {
    return Intl.message('Tots Paris', name: 'storeTitle', desc: '', args: []);
  }
  ...
  String get closingTime {
    return Intl.message('Closing In', name: 'closingTime', desc: '', args: []);
  }

  /// `Closing In`
  String get endTime {
    return Intl.message('Closing In', name: 'endTime', desc: '', args: []);
  }
  ...
  /// `Skip`
  String get skipText {
    return Intl.message('Skip', name: 'skipText', desc: '', args: []);
  }
  ...
  String get notMember {
    return Intl.message('Not a member?', name: 'notMember', desc: '', args: []);
  }
  ...
  String get cartScreenName {
    return Intl.message('Cart', name: 'cartScreenName', desc: '', args: []);
  }

  /// `items`
  String get cartItems {
    return Intl.message('items', name: 'cartItems', desc: '', args: []);
  }
  ...
  String get couponApply {
    return Intl.message('Apply', name: 'couponApply', desc: '', args: []);
  }
  ...
  /// `Town / City*`
  String get cityTown {
    return Intl.message('Town / City*', name: 'cityTown', desc: '', args: []);
  }
  ...
  String get stateHint {
    return Intl.message('Enter a State', name: 'stateHint', desc: '', args: []);
  }
  ...
  String get updateHint {
    return Intl.message('Updating...', name: 'updateHint', desc: '', args: []);
  }
  ...
  String get totalReview {
    return Intl.message('(22 Review)', name: 'totalReview', desc: '', args: []);
  }
  ...
  /// `No reviews`
  String get noReview {
    return Intl.message('No reviews', name: 'noReview', desc: '', args: []);
  }
  ...
  /// `Message`
  String get massage {
    return Intl.message('Message', name: 'massage', desc: '', args: []);
  }
  ...
  String get payNowButton {
    return Intl.message('Pay Now', name: 'payNowButton', desc: '', args: []);
  }
